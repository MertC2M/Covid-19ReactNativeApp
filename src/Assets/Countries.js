const data = [
    ...
    }, {'name': 'Argentina', 'iso2': 'AR', 'iso3': 'ARG'},
    {
        ...
        'iso2': 'BG',
        'iso3': 'BGR',
    }, {'name': 'Burkina Faso', 'iso2': 'BF', 'iso3': 'BFA'}, {'name': 'Burma'}, {
        'name': 'Burundi',
        'iso2': 'BI',
        'iso3': 'BDI',
    }, {'name': 'Cabo Verde'}, {'name': 'Cambodia', 'iso2': 'KH', 'iso3': 'KHM'}, {
        'name': 'Cameroon',
        'iso2': 'CM',
        'iso3': 'CMR',
        ...
        'iso2': 'CF',
        'iso3': 'CAF',
    }, {'name': 'Chad', 'iso2': 'TD', 'iso3': 'TCD'}, {'name': 'Chile', 'iso2': 'CL', 'iso3': 'CHL'}, {
        'name': 'China',
        'iso2': 'CN',
        'iso3': 'CHN',
        ...
        'iso2': 'KM',
        'iso3': 'COM',
    }, {'name': 'Congo (Brazzaville)'}, {'name': 'Congo (Kinshasa)'}, {
        'name': 'Costa Rica',
        'iso2': 'CR',
        'iso3': 'CRI',
    }, {'name': 'Cote d\'Ivoire'}, {'name': 'Croatia', 'iso2': 'HR', 'iso3': 'HRV'}, {
        'name': 'Cuba',
        'iso2': 'CU',
        'iso3': 'CUB',
        ...
        'iso2': 'CZ',
        'iso3': 'CZE',
    }, {'name': 'Denmark', 'iso2': 'DK', 'iso3': 'DNK'}, {'name': 'Diamond Princess'}, {
        'name': 'Djibouti',
        'iso2': 'DJ',
        'iso3': 'DJI',
        ...
        'iso2': 'EE',
        'iso3': 'EST',
    }, {'name': 'Eswatini'}, {'name': 'Ethiopia', 'iso2': 'ET', 'iso3': 'ETH'}, {
        'name': 'Fiji',
        'iso2': 'FJ',
        'iso3': 'FJI',
        ...
        'iso2': 'HT',
        'iso3': 'HTI',
    }, {'name': 'Holy See'}, {'name': 'Honduras', 'iso2': 'HN', 'iso3': 'HND'}, {
        'name': 'Hungary',
        'iso2': 'HU',
        'iso3': 'HUN',
        ...
        'iso2': 'LT',
        'iso3': 'LTU',
    }, {'name': 'Luxembourg', 'iso2': 'LU', 'iso3': 'LUX'}, {'name': 'MS Zaandam'}, {
        'name': 'Madagascar',
        'iso2': 'MG',
        'iso3': 'MDG',
        ...
        'iso2': 'NE',
        'iso3': 'NER',
    }, {'name': 'Nigeria', 'iso2': 'NG', 'iso3': 'NGA'}, {'name': 'North Macedonia'}, {
        'name': 'Norway',
        'iso2': 'NO',
        'iso3': 'NOR',
        ...
        'iso2': 'TH',
        'iso3': 'THA',
    }, {'name': 'Timor-Leste'}, {'name': 'Togo', 'iso2': 'TG', 'iso3': 'TGO'}, {
        'name': 'Trinidad and Tobago',
        'iso2': 'TT',
        'iso3': 'TTO',
    }, {'name': 'Tunisia', 'iso2': 'TN', 'iso3': 'TUN'}, {'name': 'Turkey', 'iso2': 'TR', 'iso3': 'TUR'}, {
        'name': 'US',
        'iso2': 'US',
        'iso3': 'USA',
        ...
        'iso2': 'VN',
        'iso3': 'VNM',
    }, {'name': 'West Bank and Gaza'}, {'name': 'Western Sahara', 'iso2': 'EH', 'iso3': 'ESH'}, {
        'name': 'Yemen',
        'iso2': 'YE',
        'iso3': 'YEM',
    }, {'name': 'Zambia', 'iso2': 'ZM', 'iso3': 'ZMB'}, {'name': 'Zimbabwe', 'iso2': 'ZW', 'iso3': 'ZWE'},
];
